<template>
    <div class="heroSearch style-01 shadow" style="width: 400px;">
...
<script setup>
   ...
   const options = ['Eat & Drinking', 'Rental Property', 'Classifieds','Bank Services','Shopping','Fintess & Gym','Coaching','Other Services']
