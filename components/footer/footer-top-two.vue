<template>
    <section class="bg-cover bg-dark position-relative py-5" :style="{backgroundImage:`url(${bg})`, backgroundRepeat:'no-repeat'}">
        <div class="container">
                ...
                <div class="col-xl-5 col-lg-6 col-md-6">
                    <div class="subscribeForm">
                        <div class="inputGroup">
                            ...
                            <button class="btn btn-primary"><i class="fa-regular fa-paper-plane me-2"></i>Subscribe</button>
                        </div>
                    </div>
                </div>
            </div>
