	...
	<div class="sidebarGroups d-flex flex-column gap-4">
        <div class="card">
            <div class="card-body p-0">
                <div class="avatarBox my-4">
                    <div class="square--100 circle bg-light mx-auto mb-2 p-2"><img :src="user" class="img-fluid circle" alt="Avatar"></div>
                    <div class="listingInfo text-center">
                        <p class="text-md text-muted mb-0">Hosted By</p>
                        <h6 class="mb-0">Shree K. Patel</h6>
                    </div>
                    <div class="followButtons d-block mt-3">
                        <div class="d-flex align-items-center justify-content-center gap-3 flex-wrap px-4">
                            <button type="button" class="btn btn-md btn-light-primary fw-medium flex-fill" data-bs-toggle="modal" data-bs-target="#messageModal"><i class="bi bi-envelope me-2"></i>Send Message</button>
                            <button type="button" class="btn btn-md btn-light-success fw-medium flex-fill"><i class="bi bi-send-check me-2"></i>Follow Vendor</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-footer bg-white border-top">
                <div class="d-flex align-items-center justify-content-center gap-3">
                    <div v-for="(item, index) in social" :key="index" class="flexSocial"><NuxtLink to="#" class="square--40 circle border"><i :class="item"></i></NuxtLink></div>
                </div>
            </div>
        </div>
