<template>
	<div class="sidebarGroups d-flex flex-column gap-4">
        <div class="card">
            <div class="bg-cover card-header py-3" :style="{backgroundImage:`url(${bg2})`, backgroundRepeat:'no-repeat'}" data-overlay="4">
                <div class="avatarBox position-relative z-1">
                    <div class="d-flex align-items-center justify-content-start gap-3">
                        <div class="square--80 circle bg-transparents mx-auto p-1 z-2"><img :src="user" class="img-fluid circle" alt="Avatar"></div>
                        <div class="listingInfo">
                            <p class="text-md fw-medium text-light mb-0">Posted By</p>
                            <h5 class="text-light mb-0">Shree K. Patel</h5>
                        </div>
                    </div>
                </div>
            </div>
		...
		<div class="card overflow-visible">
			<div class="card-header py-3">
				<div class="headerFirst">
					<h6><i class="bi bi-calendar-check me-2"></i>Booking Slots</h6>
				</div>
			</div>
